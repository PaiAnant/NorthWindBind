		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Northwind service binding",
									"targetURL": "#bindnorthwind-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"bindnorthwind-display": {
								"semanticObject": "bindnorthwind",
								"action": "display",
								"description": "Northwind service binding UI5 app",
								"title": "Northwind service binding",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bindnorthwind",
									"url": sap.ui.require.toUrl("bindnorthwind")
								}
							}
						}
					}
